bl_info = {
    "name": "Synchronize strips ",
    "category": "Sequencer",
    "version": (1, 0),
    "blender": (2, 7, 9),
    "location": "",
    "description": "Synchronize selected strips with active",
    "wiki_url": "https://github.com/xbodya13/synchronize_strips",
    "tracker_url": "https://github.com/xbodya13/synchronize_strips/issues"
}
...
class SynchronizeStrips(bpy.types.Operator):
    ...
    sampling_rate=bpy.props.FloatProperty(name="Sampling rate",description="Higher values increase probability of good result but also increase processing time and memory consumption", min=1, default=1000,max=44000)
    ...
    def execute(self, context):
        ...
        if temp_settings!=None:
            ...
            if len(selected_send_data)>=1:
                ...
                sync_core=os.path.join(os.path.dirname(__file__),"sync_core.py")
